  ...
  <ul>
    <li>
      <p>
        ...
        {' '}- serwis internetowy "Legited.app" działający pod adresem https://Legited.app
      </p>
    </li>
    {' '}
    <li>
    ...
    <li>
      <p>
        ...
        {' '}- Administratorem Serwisu oraz Administratorem Danych (dalej Administrator) jest osoba fizyczna "Adrian Gąsiorek" zamieszkała w Bielsku-Białej, świadcząca usługi drogą elektroniczną za pośrednictwem Serwisu
      </p>
    </li>
    {' '}
    <li>
  ...
  <ul>
    ...
    <li>
      <p>
        ...
        {' '}- Administrator oświadcza, że hasła przechowywane są w zaszyfrowanej postaci, używając najnowszych standardów i wytycznych w tym zakresie. Deszyfracja podawanych w Serwisie haseł dostępu do konta jest praktycznie niemożliwa.
      </p>
    </li>
  </ul>
  <h2
