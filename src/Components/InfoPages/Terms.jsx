...
export const Terms =() =>{
  ...
  <ul>
    ...
    <li>
      ...
      {' '}– serwis internetowych "Legited.app", działających pod adresem https:/legited.app
    </li>
    <li>
      <strong>
        Usługodawca
      </strong>
      {' '}– właściciel serwisu będący osobą fizyczną - Adrian Gąsiorek
    </li>
    <li>
      <strong>
        Usługobiorca
  ...
  <ul>
    ...
    <li>
      ...
      <a href="https://legited.app/privacy">
  ...
  <p>
    ...
    <a href="https://nety.pl/obowiazek-informacyjny-rodo/">
  ...
  <ul>
    ...
    <li>
      ...
      <ul>
        <li>
          Wysyłając wiadomość na adres e-mail: adriangasiorek@interia.pl
        </li>
        <li>
          Poprzez połączenie telefoniczne z numerem: +48 733 192 848
        </li>
      </ul>
