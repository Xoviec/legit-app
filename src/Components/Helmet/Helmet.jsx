import { Helmet, HelmetProvider as Dupa } from 'react-helmet-async';
    ...
    return(
        <Dupa>
            <Helmet>
                ...
                <meta name="keywords" content="react, meta tags, seo, streetwear,yeezy,nike,adidas,jordan,jordan low,low,dunk,dunk low,y2k,supreme,legit,legited,lc,LC,legit,legitcheck,NFC, legitedapp, legited.app, legited app, legit app, legit, check, checkcheck" />
